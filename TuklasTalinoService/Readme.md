...
WORKDIR /src
COPY ["TuklasTalinoService.csproj", "TuklasTalinoService/"]
RUN dotnet restore "TuklasTalinoService/TuklasTalinoService.csproj"

WORKDIR "/src/TuklasTalinoService"
COPY . .
RUN dotnet build "TuklasTalinoService.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "TuklasTalinoService.csproj" \
...
Execute unit tests
```
    cd "TuklasTalinoService/test/TuklasTalinoService.Tests"
    dotnet test
```

Deploy application
```
    cd "TuklasTalinoService/src/TuklasTalinoService"
